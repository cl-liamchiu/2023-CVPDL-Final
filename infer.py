...
def train_clip_styler(text, image_dir, crop_size=128, training_iterations=100, save_path=None):
    source = "a Photo"
    training_args = {
        "lambda_tv": 2e-3,
        "lambda_patch": 9000,
    ...
    for epoch in range(0, steps+1):
        ...
        if epoch == 100:
            ...
            return utils.im_convert2(output_image)


if __name__ == '__main__':
    text = "Sketch with black pencil" #@param {"type": "string"}
    image_dir = "./101_input.jpg" #@param {type: "string"}
    save_path = "./101_output.jpg"
    
    train_clip_styler(text, image_dir, save_path=save_path)